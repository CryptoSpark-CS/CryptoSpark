...
const SERVICES: ServiceCardProps[] = [
  {
    ...
    tags: ["double-entry ledgers", "payment rails", "KYC/AML", "fraud rules engines"],
  },
  {
    id: "web",
    index: "02 / WEB & MOBILE",
    ...
    tags: ["React / Next.js", "Swift / Kotlin", "React Native", "design systems"],
  },
  {
    id: "ecommerce",
    index: "03 / COMMERCE",
    ...
    tags: ["headless commerce", "custom checkout", "inventory sync", "Shopify / custom stack"],
  },
  {
    id: "blockchain",
    index: "04 / BLOCKCHAIN",
    ...
    tags: ["Solidity / EVM", "Rust / Solana", "contract audits", "on-chain monitoring"],
  },
  {
    id: "signals",
    ...
    tags: ["real-time alerts", "backtested strategies", "signal API / webhooks", "risk & position sizing"],
    wide: true,
  },
];
    ...
    <section className="section" id="services">
      <div className="wrap">
        ...
        <p className="section-desc">
          We don&apos;t hand you off between teams per specialty — the same senior engineers who
          architect your fintech ledger can wire your smart contract to it.
        </p>
